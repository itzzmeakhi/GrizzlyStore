	...
	<div class="col ">
          <div class="add-product">
            ...
            <%
				...
				ProductBean prod = prodDao.read(id);
            ...
            <div class="tab-content ">
              ...
              <div class="row top-buffer h2">
                <div class="mx-3">
                  <p> <% out.println(); %> <span class="h5">by <% out.println(prod.getProdBrand()); %></span><span class=""><i class="fas fa-pen-square h5 pl-3"></i></span></p>
                  <div class=" h6" style="color: #979797"><i class="fa fa-star"> <% out.println(prod.getProdRating()); %></i></div>
                </div>
              </div>
                <div class="row  top-buffer">
                  ...
                  <div class="col-md-4  d-flex flex-column justify-content-between">
                      <div class="row">
                        ...
                        <p><% out.println(prod.getProdDesc()); %></p>
                      </div>
                      <div class="row ">
                        <span class="h3">Rs. <% out.println(prod.getProdPrice()); %> <span class="h6"> <% out.println(prod.getProdOffer()); %>%<i class="fas fa-pen-square h5 pl-2"></i></span></span>
                      </div>
                  </div>
                </div>
              </div>

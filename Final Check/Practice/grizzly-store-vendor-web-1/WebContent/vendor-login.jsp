...
<html>
	 ...
	 -->
		...
		<script>  
			...
			function checkUserName() {
				...
				var url = "controllers/Vendor/UserNameController.jsp?UserName="+ username+"&action=valid";
			...
			window.onload = function() {
				...
				if (performance.navigation.type == 1) {
					window.location.replace("vendor-login.jsp");
				}
	...
	<body>
		...
		<div class = "container-fluid main-container">
			...
			<form class = "login-form" name = "loginForm" action = "controllers/Vendor/LoginController.jsp"> 

					...
					<div class="col-sm-8">
						...
						<ul class="nav nav-tabs" role="tablist">
							...
							<li class="nav-item">
								...
								<a class="nav-link na-col" data-toggle="tab" href="#inventory">
										...
										<tbody>
											...
											<core:forEach items="${prodDetails}" var="prod">
												<tr>
													...
													<td><core:out value="${prod.getProdId()}"></core:out></td>
													...
													<td>
														<a class="btn btn-secondary rounded-circle ml-3 mr-3" href="#"
															>View</a>
														<a class="btn btn-secondary rounded-circle ml-3 mr-3" href="#"
															>Remove</a>
													</td>
										...
										<tbody>
											...
											<core:forEach items="${prodDetails}" var="prod">
												<tr>
													...
													<td><core:out value="${prod.getProdOffer()}"></core:out></td>
													<td>
														<a class="btn btn-secondary rounded-circle ml-3 mr-3"
																href="#">View</a>
														<a class="btn btn-secondary rounded-circle ml-3 mr-3"
																href="#">Remove</a>
													</td>

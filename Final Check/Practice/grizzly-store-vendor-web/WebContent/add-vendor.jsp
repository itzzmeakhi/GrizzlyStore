...
<html>
	 ...
	 -->
		...
		<script>  
			...
			function checkUserName() {
				...
				var url = "controllers/Vendor/UserNameController.jsp?UserNameAvailable="+ username+"&action=avail";
			...
			function getUserNameInfo() {
				if (request.readyState == 4) {
					...
					document.getElementById('validateUserName').innerHTML = val;
	...
	<body>
		...
		<div class = "container-fluid main-container">
			...
			<form class = "register-form" name = "registerForm" action = "controllers/Vendor/AddVendorController.jsp"> 

				<div class = "row">

					<div class = "col offset-sm-3 col-sm-6 justify-content-md-center">

						<h1> GRIZZLY STORE - ADD VENDOR </h1>
					...
					<div class = "col offset-sm-5 col-sm-2">
						...
						<div class = "form-group">
							...
							<div class="input-group mb-2">
								...
								<input type = "text" class = "form-control" placeholder = "Enter your Username" id = "userName" name = "userName" onblur = "checkUserName()" required>
					...
					<div class="col offset-sm-5 col-sm-2">
						...
						<div class="form-group">
							...
							<div class="input-group mb-2 password">
								...
								<input type="number" class="form-control" placeholder="Enter your Mobile" id="mobile" name="mobile" required>
